...
jQuery.fn.friendselector.formatAutocompleteResult = function(event, fienddata, formatted) {
	...
	var afriendselected = '<li><input type="text" value="' + fienddata.uid + '" name="'+hiddenfieldname+'">'+ fienddata.name + ' <img src="' + fienddata.pic_small + '"/><a class="b_delete" href="javascript:;" onclick="removeSelectedFriend(this, \'#'+ $(this).attr('id') + '\')">delete</a></li>';
	if (!$(this).prev().is('ul')) {
